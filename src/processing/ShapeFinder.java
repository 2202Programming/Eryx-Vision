...
public class ShapeFinder {
	private static final float cutoff=0.2f;
	
	public static float[][] getPointsWithTopCorner(boolean[][] image) {
		Pattern topCorner=new Pattern(true, false, true, false, false, 10, 4);
		return getPointsWithPattern(image, topCorner);
	}
	
	public static float[][] getPointsWithBottomRightCorner(boolean[][] image) {
		Pattern bottomRightCorner=new Pattern(true, true, false, true, false, 10, 4);
		return getPointsWithPattern(image, bottomRightCorner);
	}
	
	public static float[][] getPointsWithBottomLeftCorner(boolean[][] image) {
		Pattern bottomLeftCorner=new Pattern(true, true, false, false, true, 10, 4);
